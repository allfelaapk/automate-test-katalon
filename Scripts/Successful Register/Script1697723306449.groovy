...
WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'toko@gmail.com')

WebUI.click(findTestObject('Object Repository/Register/div_password'))
